...
| **HL7 FHIR** | R4(2019)／R4B(2022)／R5(2023)／**R6 は 2026 年に Normative ballot**（公開は 2027 年頃見込み） | RESTful API＋リソースモデル。**R4が事実上の業界標準**（Epic・Oracle Health等が本番API）。R5は本番未定着 |
...
本シリーズの強制メカニズム（M1〜M6）を医療に適用する。医療は **中〜強強制力型（M2＋M5）** に位置づけられる。
